...
export function Inventory() {
  ...
  return (
    <>
      ...
      <div className="grid w-full max-w-[1300px] mx-auto [grid-template-columns:repeat(auto-fit,minmax(154px,1fr))] px-2 select-none [grid-gap:1em] place-content-start justify-center">
