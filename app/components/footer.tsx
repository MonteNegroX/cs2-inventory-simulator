...
import { useNavigate, useLocation } from "react-router-dom"; // ✅ оставляем
// ❌ УДАЛЯЕМ импорт useInventoryFilters
...
export function Footer() {
  ...
  const handleClick = (to: string) => {
    navigate(to);
    window.dispatchEvent(new Event("set-filters-graphicart-stickers")); // ✅ триггер фильтра
  };
